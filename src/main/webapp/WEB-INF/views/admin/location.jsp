			...
			<div class="container-fluid pt-4 px-4">
				<div class="bg-light rounded p-4 text-center">
					...
					<button type="button" class="btn btn-secondary" style="display:inline-block"
					        onclick='window.open("<%=request.getContextPath()%>/admin/location/insert", "쿠폰 등록", "width=500, height=auto")'>등록하기</button>
					</div>
					<table class="table table-hover">
						<thead>
							<tr class="text-dark">
								<th scope="col" style="width: 5%;">#</th>
								<th scope="col" style="width: 10%;">지점명</th>
								<th scope="col" style="width: 20%%;">전화번호</th>
								<th scope="col" style="width: 15%;">운영시간</th>
...
<script>
	$('.dropdown-item').eq(3).addClass('active');
	
	$('[name=pageBtn]').on('click', function() {
		let page = $(this).val();
		location.href="${pageContext.request.contextPath}/admin/location?page=" + page;
	})
