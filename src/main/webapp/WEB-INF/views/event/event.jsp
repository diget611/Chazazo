...
<body>
	...
	<script>
		...
		function getList() {
			...
			html += '<div class="panel panel-default">';
			html += '	<div class="cm-rounded bg-white">';
			html += '<img class="js-event-list-item-img event-list-item-img center-crop object-fit w-100" src="https://d1y0pslxvt2ep5.cloudfront.net/event/banner/banner_1675659784404_101.png">'
			html += '		<div class="px-3 py-2">';
			html += '		<div class="dc-flex flex-wrap justify-content-between align-items-center text-16 my-md-1">';
			html += '		<span class="js-event-list-item-txt-peroid event-list-item-txt-peroid text-12 color-grey-5">2023.02.15~2023.06.30</span>';
			html += '	</div></div></div></div>';
			...
			html += '<div class="panel panel-default">';
			html += '	<div class="cm-rounded bg-white">';
			html += ' <img class="js-event-list-item-img event-list-item-img center-crop object-fit w-100" src="https://d1y0pslxvt2ep5.cloudfront.net/event/banner/banner_1672636119046_246.png">'
			html += '		<div class="px-3 py-2">';
			html += '		<div class="dc-flex flex-wrap justify-content-between align-items-center text-16 my-md-1">';
			html += '		<span class="js-event-list-item-txt-peroid event-list-item-txt-peroid text-12 color-grey-5">2023.02.15~2024.06.30</span>';
			html += '	</div></div></div></div>';

			html += '<div class="panel panel-default">';
			html += '	<div class="cm-rounded bg-white">';
			html += ' <img class="js-event-list-item-img event-list-item-img center-crop object-fit w-100" src="https://d1y0pslxvt2ep5.cloudfront.net/event/banner/banner_1678177325199_813.png">	'
			html += '		<div class="px-3 py-2">';
			html += '		<div class="dc-flex flex-wrap justify-content-between align-items-center text-16 my-md-1">';
			html += '		<span class="js-event-list-item-txt-peroid event-list-item-txt-peroid text-12 color-grey-5">2023.02.15~2025.06.30</span>';
			html += '	</div></div></div></div>';

			html += '<div class="panel panel-default">';
			html += '	<div class="cm-rounded bg-white">';
			html += '<img class="js-event-list-item-img event-list-item-img center-crop object-fit w-100" src="https://d1y0pslxvt2ep5.cloudfront.net/event/banner/banner_214_20230316053616.png">'
			html += '		<div class="px-3 py-2">';
			html += '		<div class="dc-flex flex-wrap justify-content-between align-items-center text-16 my-md-1">';
			html += '		<span class="js-event-list-item-txt-peroid event-list-item-txt-peroid text-12 color-grey-5">2023.04.15~2023.06.30</span>';
			html += '	</div></div></div></div>';
			
			html += '<div class="panel panel-default">';
			html += '	<div class="cm-rounded bg-white">';
			html += '<img class="js-event-list-item-img event-list-item-img center-crop object-fit w-100" src="https://d1y0pslxvt2ep5.cloudfront.net/event/banner/banner_1675659797567_859.png">'
			html += '		<div class="px-3 py-2">';
			html += '		<div class="dc-flex flex-wrap justify-content-between align-items-center text-16 my-md-1">';
			html += '		<span class="js-event-list-item-txt-peroid event-list-item-txt-peroid text-12 color-grey-5">2023.06.15~2023.06.30</span>';
			html += '	</div></div></div></div>';
