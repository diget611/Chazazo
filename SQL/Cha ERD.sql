...
CREATE TABLE VEHICLE (
     ...
     , THUMBNAIL_IMG VARCHAR2(300) NOT NULL
...
INSERT INTO VEHICLE VALUES(VEHICLE_SEQ.NEXTVAL, '코나', 5, 50000, 'https://dimg.donga.com/wps/NEWS/IMAGE/2023/01/18/117485946.1.jpg', '썸네일11', '현대', 5, 2, 2);
INSERT INTO VEHICLE VALUES(VEHICLE_SEQ.NEXTVAL, '캐스퍼', 2, 45000, '이미지1', '이미지11', '현대', 1, 1, 1);
INSERT INTO VEHICLE VALUES(VEHICLE_SEQ.NEXTVAL, '제네시스', 3, 65000, '이미지2', '이미지22', '현대', 2, 3, 2);
INSERT INTO VEHICLE VALUES(VEHICLE_SEQ.NEXTVAL, '트럭', 8, 25000, '이미지3', '이미지33', '볼보', 3, 3, 3);
INSERT INTO VEHICLE VALUES(VEHICLE_SEQ.NEXTVAL, '스파크', 7, 33000, '이미지4', '이미지44', '쉐보레', 4, 2, 3);
