...
<body>
	...
	<div id="js_mypage_left_menu"><div class="text-left pt-5"><div>
	<h3 class="color-grey-3 text-14 list-border-bottom">렌트내역</h3>
	<div class="list-group list-group-flush">
	<a class="js-mypage-btn-left-menu js-mypage-btn-curr-rent py-2 text-decoration-none px-0 click-effect-press active" data-type="curr_reserv">렌트 중인 차량</a><a class="js-mypage-btn-left-menu js-mypage-btn-none-member-search py-2 text-decoration-none px-0 tmobi-dc-none click-effect-press" data-type="none_member_reserv">비회원 예약조회</a></div></div></div><div class="text-left pt-5"><div><h3 class="color-grey-3 text-14 list-border-bottom">메뉴</h3><div class="list-group list-group-flush"><a class="js-mypage-btn-left-menu js-mypage-btn-setting py-2 text-decoration-none px-0 click-effect-press" data-type="setting">설정</a><a class="js-mypage-btn-left-menu js-btn-manage-keyin-card dc-none py-2 text-decoration-none px-0 click-effect-press" data-type="manage_card" style="display: none;">간편 카드관리</a><a class="js-mypage-btn-left-menu js-btn-mypage-invite-friend py-2 text-decoration-none px-0 dc-none tmobi-dc-none click-effect-press" data-type="invite_friend" style="display: none;">친구초대</a><a class="js-mypage-btn-left-menu js-btn-manage-favorite-loc dc-none py-2 text-decoration-none px-0 click-effect-press" data-type="manage_favorite_loc" style="display: none;">즐겨찾는 장소 설정</a><a class="js-mypage-btn-left-menu js-mypage-btn-profile py-2 text-decoration-none px-0 dc-none click-effect-press" style="display: none;">내 정보 관리</a><a class="js-mypage-btn-left-menu js-btn-go-help-for-mypage py-2 text-decoration-none px-0 click-effect-press" data-type="faq">자주묻는 질문</a></div></div></div><div class="text-left pt-5 tmobi-dc-none"><div><h3 class="color-grey-3 text-14 list-border-bottom">패밀리</h3><div class="list-group list-group-flush"><a class="js-mypage-btn-left-menu js-mypage-btn-go-family-lounge py-2 text-decoration-none px-0 click-effect-press">패밀리 라운지</a><a class="js-mypage-btn-left-menu js-mypage-btn-family-intro py-2 text-decoration-none px-0 click-effect-press">패밀리 소개</a></div></div></div></div>
