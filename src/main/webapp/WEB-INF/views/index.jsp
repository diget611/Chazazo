...
<link href="<%=request.getContextPath() %>/resources/garoestate/assets/fonts/icon-7-stroke/css/pe-icon-7-stroke.css"
	rel="stylesheet">
		...
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html"><img
					src="<%=request.getContextPath() %>/resources/garoestate/assets/img/logo.png" alt=""></a>
			</div>
			...
			<div class="collapse navbar-collapse yamm" id="navigation">
				<div class="button navbar-right">
					<button class="navbar-btn nav-button wow bounceInRight login"
						onclick=" window.open('register.html')" data-wow-delay="0.45s">Login</button>
	...
	<div class="slider-area">
		<div class="slider">
			<div id="bg-slider" class="owl-carousel owl-theme">
				...
				<div class="item">
					<img src="<%=request.getContextPath() %>/resources/garoestate/assets/img/slide1/slider-image-2.jpg"
						alt="The Last of us">
				</div>
				<div class="item">
					<img src="<%=request.getContextPath() %>/resources/garoestate/assets/img/slide1/slider-image-1.jpg" alt="GTA V">
				...
				<div class="proerty-th">
						...
						<div class="box-two proerty-item">
							<div class="item-thumb">
								<a href="property-1.html"><img
									src="<%=request.getContextPath() %>/resources/garoestate/assets/img/demo/property-1.jpg"></a>
							</div>
						...
						<div class="box-two proerty-item">
							<div class="item-thumb">
								<a href="property-2.html"><img
									src="<%=request.getContextPath() %>/resources/garoestate/assets/img/demo/property-2.jpg"></a>
							</div>
							<div class="item-entry overflow">
								<h5>
						...
						<div class="box-two proerty-item">
							<div class="item-thumb">
								<a href="property-3.html"><img
									src="<%=request.getContextPath() %>/resources/garoestate/assets/img/demo/property-3.jpg"></a>
					...
					<div class="col-sm-6 col-md-3 p0">
						<div class="box-two proerty-item">
							<div class="item-thumb">
								<a href="property-1.html"><img
									src="<%=request.getContextPath() %>/resources/garoestate/assets/img/demo/property-4.jpg"></a>
						...
						<div id="testimonial-slider">
							<div class="item">
								...
								<div class="client-face wow fadeInRight" data-wow-delay=".9s">
									<img src="<%=request.getContextPath() %>/resources/garoestate/assets/img/client-face1.png" alt="">
								</div>
							</div>
							<div class="item">
								<div class="client-text">
								...
								<div class="client-face">
									<img src="<%=request.getContextPath() %>/resources/garoestate/assets/img/client-face2.png" alt="">
								</div>
							</div>
							<div class="item">
								<div class="client-text">
				...
				<div class="row">
					...
					<div class="col-md-3 col-sm-6 wow fadeInRight animated">
						<div class="single-footer">
							...
							<img src="<%=request.getContextPath() %>/resources/garoestate/assets/img/footer-logo.png" alt="" class="wow pulse"
								data-wow-delay="1s">
								...
								<li>
									<div class="col-md-3 col-sm-4 col-xs-4 blg-thumb p0">
										<a href="single.html"> <img
											src="<%=request.getContextPath() %>/resources/garoestate/assets/img/demo/small-proerty-2.jpg">
